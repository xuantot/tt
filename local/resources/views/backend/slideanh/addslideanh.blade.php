        ...
        <form  method="post" enctype="multipart/form-data" action="">
          ...
          <div class="box-body">
            <div class="form-group">                          
              ...
              <input type="text" class="form-control" id="pic_name" name="pic_name" placeholder="anh 1">
            </div>
            <div class="form-group">
              <label>Ảnh : ( 2000 x 800 px )</label>    
              @if($errors->has('pic_img'))<p class='text-red'><strong>{{$errors->first('pic_img')}}</p></strong>@endif     
              <input type="file" class="form-control" id="form_pic" name="pic_img" class="form-control" style="display:none" onchange="changeImg(this)">
              <img id="avatar" class="thumbnail cursorpoint" width="1000px" height="400px" src="public/image/import-img.png">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pic_link" name="pic_link" placeholder="https://inteaca.com/gioithieu">
              </div>
            <div class="form-group">
              <label>Sắp Xếp</label>
              @if($errors->has('pic_order'))<p class='text-red'><strong>{{$errors->first('pic_order')}}</p></strong>@endif   
              <input type="text" class="form-control" id="pic_order" name="pic_order" placeholder="">
            </div>           
          </div>
          <!-- /.box-body -->
